...
class EshopCard extends Component {
  ...
  render() {
    const { notFoundFilterData, categoryofProduct, filteredData, removeValue, showAllProducts, showproducts, allData ,productsData, colorsofProduct, sizesofProducts } = this.props;
